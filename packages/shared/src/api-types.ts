/**
 * Shared HTTP wire-contract types for the wow-threat API.
 *
 * These types define the public API surface shared between the backend and
 * frontend. Both apps import from this module to ensure compile-time alignment.
 */
import type {
  PlayerClass,
  ReportVisibility,
