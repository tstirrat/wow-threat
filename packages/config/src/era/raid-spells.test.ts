/**
 * Tests for Vanilla Era raid spell organization.
 */
...
describe('era raid spell organization', () => {
  ...
  it('composes aq40 aura modifiers in era config', () => {
    expect(Object.keys(eraConfig.auraModifiers)).toEqual(['26400'])
  })
})
